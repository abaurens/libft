...
/*   Updated: 2019/09/10 19:56:22 by abaurens         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**	Vector 3 float
*/
t_dbl		vec2f_norm__(t_vec2f *v);
t_flt		vec2f_normf__(t_vec2f *v);
t_ldbl		vec2f_norml__(t_vec2f *v);
...
t_vec2f		*vec2f_add1__(t_vec2f *v1, t_big i);
t_vec2f		*vec2f_sub1__(t_vec2f *v1, t_big i);
t_vec2f		*vec2f_mul1__(t_vec2f *v1, t_big i);
t_vec2f		*vec2f_div1__(t_vec2f *v1, t_big i);
...
**	Vector 3 double
*/
t_dbl		vec2_norm__(t_vec2 *v);
t_flt		vec2_normf__(t_vec2 *v);
t_ldbl		vec2_norml__(t_vec2 *v);
