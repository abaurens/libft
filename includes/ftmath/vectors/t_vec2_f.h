...
/*   Updated: 2019/09/16 12:54:21 by abaurens         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static const t_vec2_f__	g_vec2i = {
	(t_vecf_d_v__)vec2i_norm__,
	(t_vecf_f_v__)vec2i_normf__,
	(t_vecf_l_v__)vec2i_norml__,
	(t_vecf_v_vv__)vec2i_addv__,
	(t_vecf_v_vv__)vec2i_subv__,
	(t_vecf_v_vv__)vec2i_mulv__,
	(t_vecf_v_vnn__)vec2i_add2__,
	(t_vecf_v_vnn__)vec2i_sub2__,
	(t_vecf_v_vnn__)vec2i_mul2__,
	(t_vecf_v_vn__)vec2i_add1__,
	(t_vecf_v_vn__)vec2i_sub1__,
	(t_vecf_v_vn__)vec2i_mul1__,
	(t_vecf_v_vn__)vec2i_div1__,
	(t_vecf_v_v__)vec2i_normalize__,
	(t_vecf_d_vv__)vec2i_dot__,
};
...
t_dbl__		vec2f_dot__(t_vec2f *v1, t_vec2f *v2);

static const t_vec2_f__	g_vec2f = {
	(t_vecf_d_v__)vec2f_norm__,
	(t_vecf_f_v__)vec2f_normf__,
	(t_vecf_l_v__)vec2f_norml__,
	(t_vecf_v_vv__)vec2f_addv__,
	(t_vecf_v_vv__)vec2f_subv__,
	(t_vecf_v_vv__)vec2f_mulv__,
	(t_vecf_v_vnn__)vec2f_add2__,
	(t_vecf_v_vnn__)vec2f_sub2__,
	(t_vecf_v_vnn__)vec2f_mul2__,
	(t_vecf_v_vn__)vec2f_add1__,
	(t_vecf_v_vn__)vec2f_sub1__,
	(t_vecf_v_vn__)vec2f_mul1__,
	(t_vecf_v_vn__)vec2f_div1__,
	(t_vecf_v_v__)vec2f_normalize__,
	(t_vecf_d_vv__)vec2f_dot__,
};
...
static const t_vec2_f__	g_vec2d = {
	(t_vecf_d_v__)vec2_norm__,
	(t_vecf_f_v__)vec2_normf__,
	(t_vecf_l_v__)vec2_norml__,
	(t_vecf_v_vv__)vec2_addv__,
	(t_vecf_v_vv__)vec2_subv__,
	(t_vecf_v_vv__)vec2_mulv__,
	(t_vecf_v_vnn__)vec2_add2__,
	(t_vecf_v_vnn__)vec2_sub2__,
	(t_vecf_v_vnn__)vec2_mul2__,
	(t_vecf_v_vn__)vec2_add1__,
	(t_vecf_v_vn__)vec2_sub1__,
	(t_vecf_v_vn__)vec2_mul1__,
	(t_vecf_v_vn__)vec2_div1__,
	(t_vecf_v_v__)vec2_normalize__,
	(t_vecf_d_vv__)vec2_dot__,
};
...
static const t_vec2_f__	g_vec2l = {
	(t_vecf_d_v__)vec2l_norm__,
	(t_vecf_f_v__)vec2l_normf__,
	(t_vecf_l_v__)vec2l_norml__,
	(t_vecf_v_vv__)vec2l_addv__,
	(t_vecf_v_vv__)vec2l_subv__,
	(t_vecf_v_vv__)vec2l_mulv__,
	(t_vecf_v_vnn__)vec2l_add2__,
	(t_vecf_v_vnn__)vec2l_sub2__,
	(t_vecf_v_vnn__)vec2l_mul2__,
	(t_vecf_v_vn__)vec2l_add1__,
	(t_vecf_v_vn__)vec2l_sub1__,
	(t_vecf_v_vn__)vec2l_mul1__,
	(t_vecf_v_vn__)vec2l_div1__,
	(t_vecf_v_v__)vec2l_normalize__,
	(t_vecf_d_vv__)vec2l_dot__,
};
